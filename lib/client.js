...
//Filthy hack to make all the global T9n work without a dependency.
//todo: populate the messages and remove the global
T9n = {
  texts:{
    'signIn': 'Please sign in to continue',
    'Email': 'Email Address',
    'password': 'Password',
    'dontHaveAnAccount': 'Need an account or forgot your password?'
  },
  get(state, markIfMissing){
    if(state in this.texts)return this.texts[state];
    return state;
  }
}
